...
//  Messenger
//
//  Created by Alex Feckanin on 5/27/22.
//
...
class LoginViewController: UIViewController {
    ...
    //MARK: - IBOutlets
    //labels
    @IBOutlet weak var emailLabelOutlet:
        UILabel!
    @IBOutlet weak var passwordLabelOutlet:
        UILabel!
    @IBOutlet weak var repeatPasswordLabel:
        UILabel!
    ...
    private func registerUser() {
        ...
        if passwordTextField.text == repeatPasswordTextField.text!{
            ...
            ProgressHUD.showFailed("The passwords do no match")
        }
