...
class ChannelsTableViewController: UITableViewController {
    ...
    private func downloadAllChannels() {
        FirebaseChannelListener.shared.downloadAllChannelsFromFirebase { (allChannels) in
    ...
    private func downloadSubscribedChannles() {
        FirebaseChannelListener.shared.downloadSubscribedChannelsFromFirebase { (subscribedChannels) in
    ...
    private func showChannelView(channel: Channel) {
        ...
        let channelVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "channelView") as! ChannelDetailTableViewController
